            ...
            <div className="swiper-wrapper blog">
              ...
              <div className="swiper-slide">
                <div className="card border-0 bg-transparent rounded-0 p-0 d-block">
                  <a href="/whatsapp-business-app-vs-whatsapp-business-api" className="img radius-7 overflow-hidden img-cover">
                  ...
                  <div className="card-body px-0">
                    <h5 className="fw-bold mt-10 title">
                      <a href="/whatsapp-business-app-vs-whatsapp-business-api">WhatsApp Business App vs WhatsApp Business API</a>
                    </h5>
              ...
              <div className="swiper-slide">
                <div className="card border-0 bg-transparent rounded-0 p-0 d-block">
                  <a href="/whatsapp-marketing-strategies-to-drive-sales" className="img radius-7 overflow-hidden img-cover">
                    <img src={img2} className="card-img-top" alt="5 Winning WhatsApp Marketing Strategies" />
                  </a>
                  <div className="card-body px-0">
                    <h5 className="fw-bold mt-10 title">
                      <a href="/whatsapp-marketing-strategies-to-drive-sales">5 Winning WhatsApp Marketing Strategies to Drive 3X More Sales</a>
                    </h5>
              ...
              <div className="swiper-slide">
                <div className="card border-0 bg-transparent rounded-0 p-0 d-block">
                  <a href="/reshaping-customer-engagement-on-whatsapp" className="img radius-7 overflow-hidden img-cover">
                    <img src={img3} className="card-img-top" alt="Reshaping Customer Engagement on WhatsApp" />
                  </a>
                  <div className="card-body px-0">
                    <h5 className="fw-bold mt-10 title">
                      <a href="/reshaping-customer-engagement-on-whatsapp">Reshaping Customer Engagement on WhatsApp</a>
                    </h5>
              ...
              <div className="swiper-slide">
                <div className="card border-0 bg-transparent rounded-0 p-0 d-block">
                  <a href="/additional-page-1" className="img radius-7 overflow-hidden img-cover">
                    <img src={img4} className="card-img-top" alt="Additional Content 1" />
                  </a>
                  <div className="card-body px-0">
                    <h5 className="fw-bold mt-10 title">
                      <a href="/additional-page-1">WhatsApp Business API Conversation Pricing is Changing!</a>
                    </h5>
                    ...
                    <a href="/additional-page-1"> <small> Read More</small>
                    </a>
                    </div>
                </div>
              </div>
              ...
              <div className="swiper-slide">
                <div className="card border-0 bg-transparent rounded-0 p-0 d-block">
                  <a href="/additional-page-2" className="img radius-7 overflow-hidden img-cover">
                    <img src={img5} className="card-img-top" alt="Additional Content 2" />
                  </a>
                  <div className="card-body px-0">
                    <h5 className="fw-bold mt-10 title">
                      <a href="/additional-page-2">Additional Content 2</a>
                    </h5>
              ...
              <div className="swiper-slide">
                <div className="card border-0 bg-transparent rounded-0 p-0 d-block">
                  <a href="/additional-page-3" className="img radius-7 overflow-hidden img-cover">
                    <img src={img6} className="card-img-top" alt="Additional Content 3" />
                  </a>
                  <div className="card-body px-0">
                    <h5 className="fw-bold mt-10 title">
                      <a href="/additional-page-3">Additional Content 3</a>
                    </h5>
