          ...
          <div className="row">
            {index % 2 === 0 ? (
              <>
                ...
                <div className="col-md-6 col-sm-12 my-auto text-lg-start text-center">
                  ...
                  <a
                    href={section.link}
                    className="mt-30 internalpage_link color_2"
                  >
              ...
              <>
                <div className="col-md-6 col-sm-12 my-auto text-lg-start text-center">
                  ...
                  <a
                    href={section.link}
                    className={`mt-30 internalpage_link ${section.aClassName || 'color_3'}`}
                  >
                    Explore Live Chat{" "}
                    <i className="fas fa-long-arrow-right ms-2 colorfa_1 my-auto"></i>
                  </a>
