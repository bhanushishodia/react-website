...
import salesforceLogo from '../../assets/images/icons/salesforce.webp'; // Importing the image
...
function Salesforce() {
  ...
  <Helmet>
      ...
      <title>Integration for Salesforce | Anantya.ai</title>
      <meta name="robots" content="index,follow" />
      <meta 
        name="description" 
        content="Through Zapier's integration capabilities, seamlessly connect Anantya.ai with Salesforce to automate the synchronization of contact details between both platforms." 
      />
      <meta 
        name="keywords" 
        content="salesforce integration, salesforce software, salesforce crm software, salesforce crm integration, integration for salesforce" 
      />
      <meta property="og:title" content="Integration for Salesforce | Anantya.ai" />
      ...
      <meta 
        property="og:image" 
        content="https://anantya.ai/assets/img/home/salesforce.webp" 
      />
        ...
        {`
          {
            ...
            "@graph": [
              {
                "@type": "WebPage",
                "name": "Integration for Salesforce | Anantya.ai",
                "description": "Through Zapier's integration capabilities, seamlessly connect Anantya.ai with Salesforce to automate the synchronization of contact details between both platforms."
              },
              {
                "@type": "WebSite",
                "name": "Anantya",
