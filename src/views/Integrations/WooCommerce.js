...
import wooCommerceLogo from '../../assets/images/icons/woo-commerce.webp'; // Importing the image
...
function WooCommerce() {
  return (
    ...
    <Helmet>
      <title>Integration for Woocommerce | Anantya.ai</title>
      <meta name="robots" content="index,follow" />
      <meta 
        name="description" 
        content="Utilizing Zapier's integration capabilities, seamlessly link Anantya.ai with WooCommerce to automate the synchronization of contact details between both platforms and trigger messages when users make new orders." 
      />
      <meta name="keywords" content="" />
      <meta property="og:title" content="Integration for Woocommerce | Anantya.ai" />
      ...
      <meta 
        property="og:image" 
        content="https://anantya.ai/assets/img/home/woo-commerce.webp" 
      />
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "@graph": [
            {
              "@type": "WebPage",
              "name": "Integration for Woocommerce | Anantya.ai",
              "description": "Utilizing Zapier's integration capabilities, seamlessly link Anantya.ai with WooCommerce to automate the synchronization of contact details between both platforms and trigger messages when users make new orders."
            },
            {
              "@type": "WebSite",
              "name": "Anantya",
