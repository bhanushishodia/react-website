...
import blogImage from '../../assets/images/blog/meta-frequency-capping-update.webp';
       ...
       <div className="container py-4 mt-4">
                                    ...
                                    <div className="jop-info">
                                        ...
                                        <div className="text d-flex mb-20">
                                            <p>
                                                ...
                                                facilitate more relevant WhatsApp communications between businesses and their
                                                subscribers.
                                            </p>
                                        </div>
                                        <div className="text d-flex mb-20">
                                        ...
                                        <div className="text d-flex mb-20">
                                            <ul style={{ listStyleType: 'none' }}>
                                                ...
                                                <li>
                                                    ...
                                                    Notifications related to <b>Click-to-WhatsApp Ads</b> (CTWA) won't change.
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <ul style={{ listStyleType: 'disc', paddingLeft: '2rem' }}>
                                            <li>This update will ensure that businesses can send only two marketing messages to their clients within 24 hours.</li>
                                            <li>In a 24-hour session, only if a customer reverts or initiates a conversation with the business, they will be allowed to share additional promotional messages with a single number.</li>
            ...
            <div className="summary-card">
                ...
                <ul>
                    ...
                    <li><a href="#whatsapp-broadcast3">Does this affect your messages?</a></li>
                    <li><a href="#whatsapp-broadcast4">What obstacles are you likely to encounter?</a></li>
                    <li><a href="#whatsapp-broadcast5">How can frequency capping be solved?</a></li>
                    <li><a href="#whatsapp-broadcast6">In conclusion</a></li>
                </ul>
            </div>
        </div>
                            </div>
