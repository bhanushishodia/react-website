...
const WhatsAppBusinessAPI = () => {
  return (
    ...
    <Helmet>
      ...
      <meta name="description" content="Integrate your business with WhatsApp Business API. Enhance customer communication, automate messages, and boost engagement seamlessly on the same platform." />
      
      {/* Open Graph Meta Tags */}
      <meta property="og:title" content="Whatsapp Business API Integration Platform | Anantya.ai" />
      <meta property="og:type" content="article" />
      <meta property="og:description" content="Integrate your business with WhatsApp Business API. Enhance customer communication, automate messages, and boost engagement seamlessly on the same platform." />
