...
const IntegrationMain = () => {
    const services = [
        { img: instagramIcon, title: 'Instagram', link: 'integrations/instagram.html', delay: '0' },
        { img: whatsappIcon, title: 'WhatsApp Business Platform', link: 'whatsapp-business-api.html', delay: '0.2s' },
        { img: messengerIcon, title: 'Facebook Messenger', link: 'integrations/facebook-messenger.html', delay: '0.4s' },
        { img: wechatIcon, title: 'WeChat', link: 'integrations/wechat.html', delay: '0' },
        { img: lineIcon, title: 'Line', link: 'integrations/line.html', delay: '0.2s' },
        { img: viberIcon, title: 'Viber', link: 'integrations/viber.html', delay: '0.4s' },
        { img: googleBusinessMessagesIcon, title: 'Google Business Messages', link: 'integrations/google-business-messages.html', delay: '0.4s' },
        { img: smsIcon, title: 'SMS', link: 'integrations/google-business-messages.html', delay: '0.2s' }, // Update if SMS image is different
        { img: wordpressIcon, title: 'Wordpress', link: 'integrations/woocommerce.html', delay: '0.4s' },
        { img: squarespaceIcon, title: 'Squarespace', link: 'integrations/salesforce.html', delay: '0.4s' },
        { img: shopifyIcon, title: 'Shopify', link: 'integrations/salesforce.html', delay: '0.4s' }
      ];
    ...
    <>
          ...
          <div className="row">
            <div className="col-lg-5 my-auto text-lg-start text-center">
              <div className="integration info pe-lg-5">
                ...
                <a href="work-with-us.html" className="btn bg-green mt-4">
      ...
      <div className="container">
       <h2 className="wow fadeInUp pb-4 pt-5" style={{ visibility: 'visible', animationName: 'fadeInUp' }}>
                Perfect IT Solutions <span className="fw-normal">For Your Business</span>  </h2>
            ...
            <div className="row row-cols-1 row-cols-md-2 g-4 px-md-0 px-3">
              ...
              <div className="col">
                <div className="cta-card new text-center">
                  ...
                  <a href="partner-with-us.html" target="_blank" rel="noopener noreferrer" className="btn login_button mt-10">
                    Become a Partner
                  </a>
                </div>
              </div>
